defmodule Bouncingbullet.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(Bouncingbullet.Repo, []),
      # Start the endpoint when the application starts
      supervisor(BouncingbulletWeb.Endpoint, []),
      # Start your own worker by calling: Bouncingbullet.Worker.start_link(arg1, arg2, arg3)
      # worker(Bouncingbullet.Worker, [arg1, arg2, arg3]),
    ]
